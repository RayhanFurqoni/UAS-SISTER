...
- Buat kontainer LXC berikut
  ...
  - [Membuat 2 instance LXC debian 10 PHP 5.6 dan 1 instance LXC debian 10 mariadb server]
...
- Sekarang, kita perlu menulis beberapa skrip yang memungkinkan untuk melakukan instalasi frame di setiap lxc seperti persyaratan.
  ...
  - buat direktori laravel `sudo mkdir laravel` untuk mengakomodasi script yang memungkinkan untuk menginstal framework laravel.  

    - membuat 3 direktori untuk instalasi laravel
    ...
    - Kemudian, lanjut instalasi php. Dalam role php, kita membuat 2 direktori bernama handlers dan task.
 ...
 - buat direktori codeigniter `sudo mkdir ci` untuk mengakomodasi script yang memungkinkan untuk menginstal framewrok codeigniter.  
  ...
  - buat direktori db `sudo mkdir db` untuk mengakomodasi script yang memungkinkan untuk menginstal db framework.  
    ...
    - kita buat folder direktori pma untuk mengakomodasi instalasi. Dalam folder pma,
    - kita membuat 3 direktori bernama tasks, handlers, dan templates.
       ```
      ...
      - Di direktori templates, buat file pma.local . Lalu ketikan scriptnya seperti di bawah ini.
  ...
  - buat direktori wordpress `sudo mkdir wordpress` untuk mengakomodasi script yang memungkinkan untuk menginstal framework wordpress.  

    - Pada direktori wordpress, kita membuat 3 folder tasks, handlers dan templates yang akan digunakan untuk instalasi wordpress.
    ...
    - Pada direktori templates, kita membuat 3 file script seperti di bawah ini.
  ...
  - buat direktori yii `sudo mkdir yii` untuk mengakomodasi script untuk instalasi framework yii.  

    - Di direktori yii, kita membuat 3 folder tasks, handlers, dan templates yang akan digunakan dalam instalasi yii.
    ...
    -  Di direktori templates, buat file bernama yii.conf. Lalu ketikan scriptnya seperti di bawah ini.
